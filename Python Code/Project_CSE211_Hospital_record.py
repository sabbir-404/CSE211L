class HospitalRecord:
    ...
    def print_record(self):
        for record in self.patient_records:
            print("Patient ID: {:<3} Name: {:<18} Age: {:<3} Blood group: {:<3} Disease: {:<15} DOB: {:<12} Admitted Date: {:<12}".format(
...
def hospital_record_application(rec):
    ...
    while True:
        ...
        if user_input == '1':
            ...
            eq()
            print('Data sorted by Patient ID')
            eq()
            print_records()
        elif user_input == '2':
            app.radix_sort_string(1)
            eq()
            print('Data sorted by Patient Name')
            eq()
            print_records()
        elif user_input == '3':
            app.radix_sort_Patient_age()
            eq()
            print('Data sorted by Patient Age')
            eq()
            print_records()
        elif user_input == '4':
            app.radix_sort_string(3)
            eq()
            print('Data sorted by Patient Blood Group')
            eq()
            print_records()
        elif user_input == '5':
            app.radix_sort_string(4)
            eq()
            print('Data sorted by Patient Disease')
            eq()
            print_records()
        elif user_input == '6':
            app.radix_sort_string(5)
            eq()
            print('Data sorted by Patient Date of Birth')
            eq()
            print_records()
        elif user_input == '7':
            app.radix_sort_string(6)
            eq()
            print('Data sorted by Patient Admitted Data')
            eq()
            print_records()
        elif user_input == '8':
            eq()
...
#Sample data
# paitient ID, name, Age,blood group, disease, date of birth, admitted data
patient_records = [
    [4871, 'James Martinez', 32, 'AB+', 'Anemia', '1992-09-08', '2024-03-09', ],
    [2765, 'Charlotte Robinson', 70, 'O-', 'Asthma', '1954-08-21', '2024-02-22', ],
    [8942, 'Gabriel Rivera', 39, 'B-', 'Flu', '1985-11-30', '2024-01-18', ],
    [5928, 'William Clark', 38, 'A+', 'Bronchitis', '1986-06-14', '2024-02-21', ],
    [3276, 'Logan Walker', 27, 'A-', 'Flu', '1997-01-01', '2024-02-15', ],
    [6754, 'Brooklyn Gutiérrez', 33, 'B', 'Bronchitis', '1991-07-17', '2024-01-09', ],
    [4189, 'Evelyn Lewis', 33, 'O+', 'Eczema', '1991-07-26', '2024-02-18', ],
    [1897, 'Ava Thompson', 43, 'AB-', 'Pneumonia', '1981-04-03', '2024-02-26', ],
    [7532, 'Liam Jackson', 36, 'A+', 'Bronchitis', '1988-09-20', '2024-03-05', ],
    [5210, 'John Doe', 35, 'O-', 'Hypertension', '1989-05-15', '2024-03-20'],
    [3198, 'Jane Williams', 28, 'A-', 'Migraine', '1996-12-10', '2024-03-15', ], 
    [8314, 'Lucas Bell', 57, 'O-', 'Asthma', '1967-01-02', '2024-01-11', ],
    [6427, 'Aria King', 40, 'A-', 'Migraine', '1984-04-18', '2024-02-07', ],
    [4863, 'Emma Johnson', 62, 'O+', 'Arthritis', '1962-07-15', '2024-03-01', ],
    [2685, 'Harper Rodriguez', 47, 'B-', 'Diabetes', '1977-09-05', '2024-02-20', ],
    [9245, 'Mateo Hill', 51, 'B+', 'Diabetes', '1973-12-17', '2024-02-02', ],
    [1786, 'Emily Davis', 75, 'O-', 'Flu', '1949-11-05', '2024-03-13', ],
    [5432, 'Victoria Perez', 59, 'AB+', 'Pneumonia', '1965-04-29', '2024-01-25', ],
    [7162, 'Nathan Flores', 46, 'A-', 'Migraine', '1978-01-24', '2024-01-21', ],
    [3498, 'Noah Harris', 45, 'B+', 'Diabetes', '1979-05-28', '2024-03-02', ],
    [6271, 'Emma Anderson', 58, 'O-', 'Eczema', '1966-07-12', '2024-03-08', ],
    [8954, 'Mason Green', 42, 'A+', 'Hypertension', '1982-07-20', '2024-01-30' ],
    [4109, 'James Lee', 57, 'A+', 'Arthritis', '1967-03-17', '2024-02-17', ],
    [2356, 'Isabella White', 50, 'B-', 'Hypertension', '1974-11-12', '2024-03-03'],
    [6792, 'Leo Reed', 28, 'O+', 'Anemia', '1995-06-26', '2024-01-15', ],
    [9127, 'Camila Scott', 30, 'O-', 'Anemia', '1993-09-08', '2024-01-31', ]
]
